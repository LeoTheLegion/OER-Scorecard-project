/****************************************************************
	...
	used for generating a visual representation of any stat given 
...
function buildGraph(){
	...
	$( "#graph" ).remove();	
	$( "#graphLocation" ).append("<canvas  id= 'graph' style ='max-width: 500px;margin:auto;' ></canvas >");
    ...
    options: {
      ...
      title: {
        display: true,
        text: 'Your Course Affordability Results',
		fontColor: 'black'
      },
		scales: {
            yAxes: [{
